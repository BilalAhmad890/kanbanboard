          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <div className="relative">
              ...
              >
                ...
                <br />
                <span className="text-foreground dark:text-white">Effortlessly</span>
              </motion.h1>
              <motion.div
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Transform your workflow with our intuitive Kanban board. Visualize progress,
              manage tasks, and boost productivity.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={buttonHoverVariants} whileHover="hover">
              <Button
                variant="outline"
                size="lg"
                className="text-lg px-10 py-7 rounded-2xl border-2 border-muted glass hover:bg-primary/80 transition-colors"
                onClick={() => {
